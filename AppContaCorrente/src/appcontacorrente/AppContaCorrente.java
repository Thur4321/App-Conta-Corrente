...
public class AppContaCorrente {
    ...
    public static void main(String[] args) {
        ...
        String nomes = JOptionPane.showInputDialog(null, "Informe o nome dos titulares:", "Conta", 3);
                    
        int númeroConta=Integer.parseInt(JOptionPane.showInputDialog(null,"Qual o número da sua conta","Conta",3));
                    
        objConta = new ContaCorrente(nomes, númeroConta);
